      ...
      var misc = [{predicate : 'square root', owner : '9', identity : '3'}, {predicate : 'product', owner : '2 and 5', identity : '10'}, {predicate : 'king', owner : 'Spain', identity : 'Felipe VI'}, {predicate : 'enemy', owner : 'my enemy', identity : 'my friend'}, {predicate : 'importance', owner : 'being earnest', identity : 'not to be underestimated'}];
